      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-5xl sm:text-6xl font-black text-white mb-4 tracking-tight">
            Protocol <span className="bg-clip-text text-transparent bg-gradient-to-r from-purple-400 to-pink-400">Analytics</span>
          </h1>
          <p className="text-xl text-gray-400">Deep insights into the anti-rug ecosystem</p>
        </div>

        <div className="glass-card rounded-3xl p-12 text-center border border-white/10">
          <div className="text-6xl mb-6">📊</div>
          <h2 className="text-2xl font-black text-white mb-4">Analytics Dashboard Coming Soon</h2>
          <p className="text-gray-400 max-w-2xl mx-auto mb-8">
            Historical data, trend analysis, ecosystem health metrics, and more.
          </p>
          <div className="grid sm:grid-cols-3 gap-6 mt-8">
            {['Market Trends', 'Vesting Metrics', 'Risk Analysis'].map(item => (
              <div key={item} className="glass-card rounded-xl p-6 border border-white/5">
                <div className="text-2xl mb-2">📈</div>
                <div className="text-sm font-bold text-gray-400">{item}</div>
              </div>
            ))}
          </div>
        </div>
